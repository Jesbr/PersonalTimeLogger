...
With the task list the user can input tasks into the list they wish to focus on. The list will number the tasks with ([#] - ), and when the task is complete they can delete the task with the specified number in the number field and click [delete].
